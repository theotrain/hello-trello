...
this["JST"]["add_card"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"card-composer\"><div class=\"card\"><textarea class=\"autoExpand\" data-min-rows='2'></textarea></div><div class=\"add-footer\"><button class=\"add\">Add</button><div class=\"remove\"></div></div></div>";
},"useData":true});
...
this["JST"]["list"] = Handlebars.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"list\" data-id=\""
    ...
    + "</header><div class=\"list-cards\"></div><a class=\"add-card\" href=\"#\"><footer>Add a card...</footer></a></div>";
},"useData":true});